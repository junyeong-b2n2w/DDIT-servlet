 ...
 *  	(해당 서블릿이 로딩이 안된 경우는 로딩을 한다 == >  로딩시 init()메서드가 호출된다.)
 ...
 * 6. 컨테이너에서 해당 서블릿이 제거되는 경우엔 distroy()메서드가 실행된다.
 * 
 * 
 */
...
public class ServletTest03 extends HttpServlet {
	...
	@Override
	public void destroy() {
		System.out.println("Servlet : " + this.getServletName() + "에서 destory() 메서드 호출.. ");
	}
